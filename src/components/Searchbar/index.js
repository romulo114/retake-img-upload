...
import { userNavigation } from 'src/lib/routes';
import { useAuth } from '../AuthProvider';

export const SearchBar = ({ setSidebarOpen }) => {
          ...
          <div className='ml-4 flex items-center lg:ml-6'>
            ...
            <Menu as='div' className='relative ml-3'>
              <div className='relative'>
                <Menu.Button className='relative flex h-9 w-9 max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'>
